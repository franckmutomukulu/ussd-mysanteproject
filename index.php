...
if ( $text == "" ) {
  $response  = "Hello, Bonjour, Mbote, Jambo,Ingeta.  \n";
  $response .= "1. Fina 1  Lingala";
  $response .= "2. Vinya 2 Swahili";
  $response .= "3. Tshia 3 Tshiluba";
  $response .= "4. Beta 4  Kikongo";
  $response .= "5. Entre 5 Francais";
  $response .= "6. Enter 6 English";
}
...
// Will be brought to this second menu screen
  ...
  $response  = "Corona esila \n";
  $response .= "1. Lopitalo 2 \n";
  $response .= "2. yebisa 4 \n";
...
// Swahili
  ...
  $response  = "Corona ihishe \n";
  $response .= "1. hopitalo 2 \n";
  $response .= "2. yebisa 4 \n";
  $response .= "3. Table for 6 \n";
  $response .= "4. Table for 8 \n";
}
